 ...
 * exception types.
 */
public class ImpossibleFutureTransactionException extends ChallengeException {

  private static final long serialVersionUID = 7344741297265420723L;

  private final Name technicalName = Name.IMPOSSIBLE_FUTURE_TRANSACTION_EXCEPTION;
   ...
   */
  public ImpossibleFutureTransactionException(final String message, final Logger logger) {
   ...
   */
  public ImpossibleFutureTransactionException(final String message, final Logger logger, final Exception rootException) {
